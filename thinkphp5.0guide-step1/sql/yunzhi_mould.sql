...
CREATE TABLE `yunzhi_mould`  (
  ...
  `row` int(11) NOT NULL DEFAULT 0 COMMENT '行数',
  `line` int(11) NOT NULL DEFAULT 0 COMMENT '列数',
  `create_time` int(11) NOT NULL DEFAULT 0,
  `update_time` int(11) NOT NULL DEFAULT 0,
  `is_first` int(11) NOT NULL COMMENT '第一个模板',
  `is_last` int(11) NOT NULL COMMENT '最后一个模板',
